...
- Noise mitigation: Decoupling capacitors (100uF + 0.1uF) across TX/RX amplifier inputs to suppress switching regulator noise

### Sample Doppler Calculations (Df = 2fv/c)

| Motion | Speed | Df @ 5.8875 GHz |
|---|---|---|
...
- ADALM-Pluto SDR: https://www.analog.com/media/en/news-marketing-collateral/product-highlight/adalm-pluto-product-highlight.pdf
- VBFZ-5500-S+ BPF Datasheet: https://www.minicircuits.com/pdfs/VBFZ-5500-S+.pdf
- CN0523 TX Amplifier: https://wiki.analog.com/resources/eval/user-guides/circuits-from-the-lab/cn0523
- CN0534 LNA: https://wiki.analog.com/resources/eval/user-guides/circuits-from-the-lab/cn0534
- NASA FINDER — Human Detection Through Concrete: https://spinoff.nasa.gov/FINDER-Finds-Its-Way-into-Rescuers-Toolkits
- Detecting Human Presence using FMCW Radar (IEEE): https://ieeexplore.ieee.org/document/10599163
